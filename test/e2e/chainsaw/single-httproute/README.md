# Test: `single-httproute`

Verifies basic weight-based canary traffic splitting with a single HTTPRoute. The plugin must set canary weight to 30 when a canary is active and reset it to 0 once the rollout completes.
...
Plugin initializes the HTTPRoute with canary weight 0.
