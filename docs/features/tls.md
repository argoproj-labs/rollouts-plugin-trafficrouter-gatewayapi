...
2. Install [GatewayAPI CRD](https://gateway-api.sigs.k8s.io/guides/#installing-gateway-api) v1.6.0 or later if your traffic provider doesn't do it by default (TLSRoute requires the `v1` API version, available since Gateway API v1.6.0)
